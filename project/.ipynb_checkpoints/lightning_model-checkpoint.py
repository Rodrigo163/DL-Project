...
# MODEL(S)
    ...
    def __init__(self, embed_size, hidden_size, vocab_size, num_layers, root_folder, annotation_file, dataset, learning_rate):
...
# DATA
    def train_dataloader(self):
        return DataLoader(self.dataset, batch_size = 64, pin_memory = True)
